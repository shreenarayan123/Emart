    ...
    <div className='men'>
      <div className="left">
        ...
        <div className="filters">
          ...
          <div className="category">
            <input type="checkbox" id='c3' value={10} onChange={handleChange}/>
            <label htmlFor="c3">Jeans</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c4' value={11} onChange={handleChange}/>
            <label htmlFor="c4">Trousers</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c5' value={12} onChange={handleChange}/>
