      ...
      <div className="filters">
        ...
        <div className="filter">
          ...
          <div className="category">
            <input type="checkbox" id='c1' value={3} onChange={handleChange}/>
          ...
          <div className="category">
            <input type="checkbox" id='c4' value={9} onChange={handleChange}/>
            <label htmlFor="c4">Kurtis</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c5' value={10} onChange={handleChange}/>
