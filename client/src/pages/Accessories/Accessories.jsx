       ...
       <div className="left">
        ...
        <div className="filters">
          ...
          <div className="filter">
            ...
            <input type="checkbox" id='c1' value={4} onChange={handleChange}/>
            <label htmlFor="c1">Bags</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c2' value={17} onChange={handleChange}/>
            <label htmlFor="c2">Caps and Hats</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c3' value={18} onChange={handleChange}/>
            <label htmlFor="c3">Watches</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c4' value={19} onChange={handleChange}/>
            <label htmlFor="c4">Glasses</label>
          </div>
          <div className="category">
            <input type="checkbox" id='c5' value={20} onChange={handleChange}/>
